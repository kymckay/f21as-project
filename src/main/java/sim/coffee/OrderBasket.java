...
public class OrderBasket extends OrderList {
    ...
    private boolean isSandwich(Order o) {
        ...
        for (Order order : orders) {
            if (
                ...
                && (
                    ...
                    || (target.equals("F") && isSandwich(order)) // Food must be a sandwich
                )
            ) {
                saveOrder = order;
                break;
